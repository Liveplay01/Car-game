...
public struct Tuning: Sendable {
    ...
    static var fields: [Field] {
        [
            ...
            .double("lateAiGapPerLevel", \.lateAiGapPerLevel),
            .double("minAiSafeGap", \.minAiSafeGap),
            .double("lateLapChancePerLevel", \.lateLapChancePerLevel),
            .double("maxAiLapChance", \.maxAiLapChance),
            .double("lateSpawnFasterPerLevel", \.lateSpawnFasterPerLevel),
            .double("minSpawnDelayFactor", \.minSpawnDelayFactor),
