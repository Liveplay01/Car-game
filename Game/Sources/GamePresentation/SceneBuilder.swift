...
public enum SceneBuilder {
    ...
    public static func addVehicles(of world: World, alpha: Double, carSkin: ColorToken? = nil, carStripe: ColorToken? = nil, springTime: Double? = nil, to list: inout RenderList) {
        ...
        for vehicle in world.vehicles where !vehicle.isCrashed {
            ...
            CarArt.add(
                ...
                stripe: vehicle.owner == .player && (vehicle.type == .car || vehicle.type == .sportsCar) ? carStripe : nil,
